<?php
  ...
  class XboxLiveClient extends XboxLiveCommunication {
    ...
    public static function withAccessToken($access_token) {
      ...
      $instance = new self();
      $instance->authenticate($access_token);
     ...
     * @return \XboxLiveClient
     */
    public static function withAccessTokenAndRefreshToken($access_token, $refresh_token) {
      // for the initial connection generate some temp cookie file
      
      $instance = new self();
      $instance->authenticate($access_token, $refresh_token);
