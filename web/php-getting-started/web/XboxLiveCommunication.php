<?php
  ...
  class XboxLiveCommunication {
    ...
    public function authenticate($access_token = null, $refresh_token = null) {
      ...
      if (!$access_token) {
        ...
        $this->authentication_data['access_token'] = $access_token;
        $this->authentication_data['refresh_token'] = $refresh_token;
      }
    ...
    public function authorized() {
      ...
      $this->gamertag = $authorization_data->DisplayClaims->xui[0]->gtg;
    ...
    public function authorizeWithToken($authentication_data = null, $access_token) {
      if ($authentication_data) {
        $this->authentication_data = $authentication_data;
      }
      else {
